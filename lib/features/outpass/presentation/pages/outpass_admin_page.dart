// lib/features/outpass/presentation/pages/outpass_admin_page.dart
...
/// Admin-only read-only view of all outpass requests across all hostels.
class OutpassAdminPage extends ConsumerWidget {
  const OutpassAdminPage({super.key});
        ...
        data: (outpasses) {
          if (outpasses.isEmpty) {
            return const EmptyStateWidget(
              ...
              subtitle: 'All hostel outpass requests will appear here',
            );
          }
            ...
            itemBuilder: (_, i) {
              ...
              return Container(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Text(
                    DateFormatter.formatWithTime(DateTime.parse(o['created_at'])),
                    style: const TextStyle(fontSize: 11, color: AppTheme.textSecondary),
                  ),
                  if (o['out_time'] != null)
                    Padding(
                      ...
                      child: Text(
                        'OUT: ${DateFormatter.formatWithTime(DateTime.parse(o['out_time']))}',
                  ...
                  if (o['in_time'] != null)
                    Padding(
                      ...
                      child: Text(
                        'IN: ${DateFormatter.formatWithTime(DateTime.parse(o['in_time']))}',
